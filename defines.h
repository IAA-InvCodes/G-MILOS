...
struct CUANTIC{  
	...
	int N_PI;
	int N_SIG;
	REAL NUB [10];//size stored in  n_sig
	REAL NUP [10];//size stored in n_pi
	REAL NUR [10];//size stored in n_sig
	REAL WEB [10];//size stored in n_sig
	REAL WEP [10];//size stored in n_pi
	REAL WER [10];//size stored in n_sig
	REAL GL;
	REAL GU;
	REAL GEFF;
	REAL FO;	
